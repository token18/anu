...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Eo5pN07L75fxkjXtf7T5.TccI5kJV4cFlna4QQ4ZdXq.+1if+c6mwA4SW4tBgXCRb5w6uBhlGOnpKtRCZAGdmJQ=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EoBIgHHFsRSJXHaVGev1.Zit7Lb16eqId7UFrO14Xyq.irxnEe3qMt1zcb11fiAQT5BA50D3kazHrBafW46BbvM=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EonGJST3uQUZv89CGgy7.bD2h0/94Pdg1rKOFk819rW.asXN+2yqhJCmC868rTyAUW6uSBKn44HHgYhzKhCfESg=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Eoh6CFhjOqMoRs3A9qlc.7Qq30/hcogehiN4M2vRDxa.dXTX4w4vXvSoSh3VmNsW7wN1dKaB6td+f2bqMTuA3As=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='Eofkdl8Vt0o8f7XNPeK4.nPu+Ke4X84Ui3awrOgewPa.zu0Wg8w8ty5cOZ2K4sF6AcpkYbkgznCFXiyMNPNadgU=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='EoanJ85ecKxARyS7wSMf.e3oR914qeTcpEh2W5TZGZW.bA/g1MO6bavHWQ1iIjwsDEytbkYqeo4CBc1Mc7DlMZ8=')
km.loginResult()
...
╚═════════════════════════
"""
tjia="ub736c5b1794f5aa30026d162d07ce5e6"
#----------------------------------------------------------
setMessage ="""
╔═════════════════════════
║              ☆☞ S E T ☜☆
...
Creator="ub736c5b1794f5aa30026d162d07ce5e6"
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : Tamii\nContact Me : 👉 line.me/ti/p/~tidak_benar",    
    "commentOn":True,
    "commentBlack":{},
    "likeOn":False,
    "blacklist":{},
...
#--------------------------------------------------------
	    if mid in op.param3:
			...
			cl.updateGroup(G)
			cl.sendText(op.param1,"☆Thanks telah di invite ke grup ini ^_^ ☆")
                else:
...
#--------------------------------------------------------
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to, "Khusus Tamii")
#--------------------------------------------------------
...
#--------------------------------------------------------
                ...
                midd = msg.text.replace("Invite creator ","ub736c5b1794f5aa30026d162d07ce5e6")
                cl.findAndAddContactsByMid(midd)
                cl.inviteIntoGroup(msg.to,[midd])
#--------------------------------------------------------
...
#--------------------------------------------------------
            elif "@Tamii Putry" in msg.text:
              if wait["Tag"] == True:
                tanya = msg.text.replace("@Tamii Putry","")
                jawab = ("Jangan Tag Si Tamii...","Berisik Jangan Tag Si Tamii...,","Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Dia Lagi Sibuk Jangan Tag Tamii","Woii Bicik Jangan Tag Tamii Lagi Gua Bilang!!!","Tamii Lagi Off...\nKalau Penting PC Aja Tamii nya")
